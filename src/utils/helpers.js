...
//   },
// }
// export const populateMap = async () => {
//   const token =
//     'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VybmFtZSI6InRvbWl3ZXN0QGhvdG1haWwuY29tIiwiaWQiOjYzLCJpYXQiOjE2Nzc1MjIzMzF9.8n4zhE9rec5RXJNPKiQuGWG2FjZAm50QkWd5OcvCd9k'

//   const latitude = 60.16109357208893
...
//     const location = {
//       type: 'Point',
//       coordinates: [new_latitude, 24.943677891171106],
//     }
//     await axios.post(
//       `${baseUrl}/api/events`,
//       {
//         ...event,
//         post_url: `url${i}+${new Date()}`,
//         location: location,
//         id: event.id + 210 + i,
//       },
//       {
